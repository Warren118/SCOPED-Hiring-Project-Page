    ...
    <main>
      ...
      <section className="hero" id="top">
        <div className="hero-copy">
          ...
          <div className="actions"><a className="button primary" href="#microscope">Follow one trajectory <span>↓</span></a><span className="paper-status">Paper &amp; resources coming soon</span></div>
        </div>
